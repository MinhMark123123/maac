...
extension TextStyleExt on TextStyle {
  ...
  TextStyle roboto() => copyWith(fontFamily: FontFamily.roboto);

  TextStyle notoSansJP() => copyWith(fontFamily: FontFamily.notoSansJP);

  TextStyle fontQuestrial() => copyWith(fontFamily: FontFamily.questrial);
