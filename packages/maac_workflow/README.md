...
The sections below document every building block in depth, grouped the same way as the
example app's "Basics" screens (`packages/maac_workflow/example`) — one section per concept.
